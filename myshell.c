...
//void init()
//{
//	printf("Hello! I'm Sheldon, the C Posix Shell. I compute to serve thy will... \n"
//			"Supported Commands:\tls - List directory contents.\n  "
...
//	else
//		c = '$';
//	printf("<Sheldon>%s@%s:%s%c ", USER, HOSTNAME, getShortCWD(), c);
//}
//int getch()
//{
//	struct termios oldt,
